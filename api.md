...
```python
from pipeline.types import WebhookHandleGitHubResponse
```

Methods:

- <code title="post /webhooks/github">client.webhooks.<a href="./src/pipeline/resources/webhooks.py">handle_github</a>(\*\*<a href="src/pipeline/types/webhook_handle_github_params.py">params</a>) -> <a href="./src/pipeline/types/webhook_handle_github_response.py">WebhookHandleGitHubResponse</a></code>
...
```python
from pipeline.types import GitHubCheckConnectionStatusResponse, GitHubInitiateOAuthResponse
```

Methods:

- <code title="get /github/status">client.github.<a href="./src/pipeline/resources/github/github.py">check_connection_status</a>(\*\*<a href="src/pipeline/types/github_check_connection_status_params.py">params</a>) -> <a href="./src/pipeline/types/github_check_connection_status_response.py">GitHubCheckConnectionStatusResponse</a></code>
- <code title="get /github/callback">client.github.<a href="./src/pipeline/resources/github/github.py">handle_callback</a>(\*\*<a href="src/pipeline/types/github_handle_callback_params.py">params</a>) -> None</code>
- <code title="get /github/connect">client.github.<a href="./src/pipeline/resources/github/github.py">initiate_oauth</a>(\*\*<a href="src/pipeline/types/github_initiate_oauth_params.py">params</a>) -> <a href="./src/pipeline/types/github_initiate_oauth_response.py">GitHubInitiateOAuthResponse</a></code>
...
```python
from pipeline.types.github import Repository, RepoListResponse, RepoConnectResponse
```

Methods:

- <code title="get /github/repos">client.github.repos.<a href="./src/pipeline/resources/github/repos.py">list</a>(\*\*<a href="src/pipeline/types/github/repo_list_params.py">params</a>) -> <a href="./src/pipeline/types/github/repo_list_response.py">RepoListResponse</a></code>
- <code title="post /github/repos/connect">client.github.repos.<a href="./src/pipeline/resources/github/repos.py">connect</a>(\*\*<a href="src/pipeline/types/github/repo_connect_params.py">params</a>) -> <a href="./src/pipeline/types/github/repo_connect_response.py">RepoConnectResponse</a></code>
...
```python
from pipeline.types import ProjectRetrieveProgressResponse
```

Methods:

- <code title="get /projects/{project_id}/progress">client.projects.<a href="./src/pipeline/resources/projects.py">retrieve_progress</a>(project_id) -> <a href="./src/pipeline/types/project_retrieve_progress_response.py">ProjectRetrieveProgressResponse</a></code>
...
- <code title="post /deployments/{deployment_id}/cancel">client.deployments.<a href="./src/pipeline/resources/deployments.py">cancel</a>(deployment_id) -> <a href="./src/pipeline/types/deployment_cancel_response.py">DeploymentCancelResponse</a></code>
