...
from ...types.training import log_push_params
from ...types.training.log_retrieve_response import LogRetrieveResponse
...
class LogsResource(SyncAPIResource):
    ...
    def push(
        ...
        *,
        ...
        return self._post(
            f"/training/{id}/logs",
            body=maybe_transform({"content": content}, log_push_params.LogPushParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    async def push(
        ...
        *,
        ...
        return await self._post(
            f"/training/{id}/logs",
            body=await async_maybe_transform({"content": content}, log_push_params.LogPushParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
