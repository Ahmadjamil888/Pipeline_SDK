...
class ReposResource(SyncAPIResource):
    ...
    def analyze(
        ...
        *,
        ...
        """
        Creates a Daytona workspace, clones the repository, and runs AI analysis to
        detect frameworks, services, and recommend deployment platforms.
    ...
    def connect(
        ...
        *,
        ...
        """
        Connect a Git repository from GitHub or GitLab to the platform

        Args:
          provider: Git provider

          repo_url: Full URL to the Git repository
